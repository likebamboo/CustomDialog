...
public class CustomAlertController {
    ...
    public static int m_MyAlertContentViewId = R.layout.custom_alert_dialog;
    ...
    private void setBackground(LinearLayout topPanel, LinearLayout contentPanel, View customPanel,
            boolean hasButtons, TypedArray axxd, boolean hasTitle, View buttonPanel) {
    ...
    public static class AlertParams {
        ...
        private void createListView(final CustomAlertController dialog) {
            final RecycleListView listView = (RecycleListView)mInflater.inflate(
                    R.layout.custom_select_dialog, null);
            ListAdapter adapter;

            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(mContext,
                            R.layout.custom_select_dialog_multichoice, android.R.id.text1, mItems) {
                        @Override
                ...
                if (mCursor == null) {
                    adapter = (mAdapter != null) ? mAdapter : new ArrayAdapter<CharSequence>(
                            mContext, layout, android.R.id.text1, mItems);
                } else {
